...
class FtxClient:
    ...
    def get_market_history(self, market: str = None, resolution: int = None, limit: int = 5000, start_time: float = None, end_time: float = None) -> List[dict]:
    ...
    def get_order_status(self, orderID: str = None) -> List[dict]:
        return self._get(f'orders/'+str(orderID))
